...
namespace PrepareLanding
{
    ...
    public class TabLoadSave : TabGuiUtility
    {
            ...
            base(columnSizePercent)
        {
            ...
            _stylePresetInfo = new GUIStyle(Verse.Text.textFieldStyles[1])
            {
        ...
        private void DrawLoadPresetInfo(Rect inRect)
        {
            ...
            TextAreaScrollable(descriptionRect, preset.PresetInfo.Description,
        ...
        {
            Rect rect2 = new Rect(0f, 0f, rect.width - 16f, Mathf.Max(Verse.Text.CalcHeight(text, rect.width) + 10f, rect.height));
        ...
        private void DrawSaveFileName(Rect inRect)
        {
            ...
            var descriptionRect = ListingStandard.GetRect(80f);
            _presetDescriptionSave = TextAreaScrollable(descriptionRect, _presetDescriptionSave,
